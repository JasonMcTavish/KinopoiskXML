...
import com.example.androidfinal.data.FILM_TYPE
import com.example.androidfinal.data.SORTING_PARAMS
import com.example.androidfinal.databinding.FragmentSearchSettingsBinding
    ...
    private fun onClickFilterCountryGenreChoose() {
        binding.searchSettingsCountryTv.setOnClickListener {
            val action = SearchSettingsFragmentDirections
                .actionFragmentSearchSettingsToFragmentSearchFilters(SearchFiltersFragment.KEY_COUNTRY)
            findNavController().navigate(action)
        }
        binding.searchSettingsGenreTv.setOnClickListener {
            val action = SearchSettingsFragmentDirections
                .actionFragmentSearchSettingsToFragmentSearchFilters(SearchFiltersFragment.KEY_GENRE)
            findNavController().navigate(action)
        }
    }
