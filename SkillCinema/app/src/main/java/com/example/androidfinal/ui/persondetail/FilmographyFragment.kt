...
import com.example.androidfinal.databinding.FragmentFilmographyBinding
...
class FilmographyFragment : Fragment() {
    ...
    private fun onFilmClick(filmId: Int) {
        val action =
            FilmographyFragmentDirections.actionFragmentFilmographyToFragmentFilmDetail(filmId)
